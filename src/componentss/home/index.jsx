  ...
  return (
    <div className=''>
        <div className='bg-primary-100 h-[112rem] md:h-[85rem]'>
            <div className="pt-0">
                ...
                <div className='pt-12'>
                    ...
                    <div
                    className="flex flex-col items-center md:flex-row md:justify-center gap-3 md:gap-9 pt-14"
                    data-aos="fade-up"
                    >
                ...
                <div className="flex flex-col items-center justify-center min-h-screen p-20 md:pt-40" data-aos="fade-up">
                    <div>
                    ...
                    <div className="text-center mt-4">
                        <Link to="target" smooth={true} duration={700}>
                            <button className="rounded p-1 md:p-2 text-sm md:text-lg text-gray-100 bg-red-700 active:bg-red-800 duration-200">
        ...
        {/* min-h-dvh */}
            ...
            <div id='target' className='min-h-[50rem]  m-auto shadow-2xl bg-yellow-700 mt-52 w-[18rem] sm:w-[30rem] md:w-[35rem] border-2 border-yellow-600 rounded flex-row justify-center'>
